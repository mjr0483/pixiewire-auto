...
export const DEFAULT_CONTENT_TYPES: ContentType[] = [
  ...
  { id: "roundup", label: "Daily Roundup", maxChars: 280, description: "ICYMI end-of-day summary of top headlines, drives to pixiewire.com/daily", urlStrategy: "pixiewire.com/daily", bestTimeSlots: ["Evening"], automated: true },
