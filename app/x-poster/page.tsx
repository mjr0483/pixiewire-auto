    ...
    <>
      <div className="header">
        ...
        <a href="/" style={{
          ...
          fontFamily: "var(--mono)", fontSize: 10, letterSpacing: "0.06em", textTransform: "uppercase" as const,
          color: "var(--muted)", textDecoration: "none", border: "1px solid var(--rule-light)", borderRadius: 6,
          padding: "6px 12px",
        }}>&larr; Dashboard</a>
      </div>
